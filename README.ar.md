...
# XXD Panel 195｜مونتاج أرشيفي بلمسة مضيئة واحدة
...
مونتاج أرشيفي بلمسة مضيئة واحدة
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 195 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-195`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-195 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-195-prompt.en.md) أو [بالصينية](references/xxd-panel-195-prompt.zh-CN.md).
